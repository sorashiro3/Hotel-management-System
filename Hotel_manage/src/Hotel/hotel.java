    ...
    static void CustDetails(int i,int rn)
    {
        ...
        switch (i) {
            case 1:hotel_ob.luxury_doublerrom[rn]=new Doubleroom(name,contact,gender,name2,contact2,gender2);
                    DoubleroomDAO doubleroomDAO = new DoubleroomDAO() ;
                    doubleroomDAO.addDoubleRoom(hotel_ob.luxury_doublerrom[rn]);
                break;
            case 2:hotel_ob.deluxe_doublerrom[rn]=new Doubleroom(name,contact,gender,name2,contact2,gender2);
                    DoubleroomDAO doubleroomDAO1 = new DoubleroomDAO() ;
                    doubleroomDAO1.addDoubleRoom(hotel_ob.deluxe_doublerrom[rn]);
                break;
            case 3:hotel_ob.luxury_singleerrom[rn]=new Singleroom(name,contact,gender);
                    SingleroomDAO singleroomDAO = new SingleroomDAO() ;
                    singleroomDAO.addSingleRoom(hotel_ob.luxury_singleerrom[rn]);
                break;
            case 4:hotel_ob.deluxe_singleerrom[rn]=new Singleroom(name,contact,gender);
                    SingleroomDAO singleroomDAO1 = new SingleroomDAO() ;
                    singleroomDAO1.addSingleRoom(hotel_ob.deluxe_singleerrom[rn]) ;
                break;
        ...
        switch(rtype)
        {
            case 1:
                ...
                for(Food obb:hotel_ob.luxury_doublerrom[rn].food)
                {
                    ...
                    System.out.printf(format,list[obb.item_no-1],obb.quantity,obb.price );
                    FoodDAO foodDAO = new FoodDAO() ;
                    foodDAO.addFoodItem(obb) ;
                }
            ...
            do
            {
                ...
                switch(rtype){
                    case 1: hotel_ob.luxury_doublerrom[rn].food.add(new Food(i,q));
                            foodDAO.addFoodItem(new Food(i,q)) ;
                        break;
